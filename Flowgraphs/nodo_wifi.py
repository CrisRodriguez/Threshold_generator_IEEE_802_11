...
# Title: Nodo Wifi
# Generated: Mon Jul 24 16:50:42 2017
##################################################
...
from Wifi_rx_PHY import Wifi_rx_PHY  # grc-generated hier_block
from Wifi_tx_PHY import Wifi_tx_PHY  # grc-generated hier_block
...
class nodo_wifi(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Nodo Wifi")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Nodo Wifi")
        ...
        self.settings = Qt.QSettings("GNU Radio", "nodo_wifi")
        ...
        self._snr_range = Range(1, 200, 1, 1, 200)
        ...
        self._period_range = Range(1, 1000, 1, 100, 200)
        ...
        self._interval_range = Range(1, 10000, 100, 4000, 200)
        ...
        self.ieee802_11_tx_mac_0 = ieee802_11.tx_mac(([0x23, 0x23, 0x23, 0x23, 0x23, 0x23]), ([0x42, 0x42, 0x42, 0x42, 0x42, 0x42]), ([0xff, 0xff, 0xff, 0xff, 0xff, 0xff]))
        self.ieee802_11_threshold_generator_0 = ieee802_11.threshold_generator(0.7,False,rx_gain)
        self.ieee802_11_rx_mac_0 = ieee802_11.rx_mac(([0x23, 0x23, 0x23, 0x23, 0x23, 0x23]), ([0x42, 0x42, 0x42, 0x42, 0x42, 0x42]), ([0xff, 0xff, 0xff, 0xff, 0xff, 0xff]))
        self.ieee802_11_parse_mac_0 = ieee802_11.parse_mac(False, False)
        self.ieee802_11_message_handler_0 = ieee802_11.message_handler(False, False)
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_vcc((snr, ))
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.intern("TEST"), period)
        self.blocks_message_debug_0 = blocks.message_debug()
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, '/tmp/wifi_out.pcap', True)
        self.blocks_file_sink_0_0.set_unbuffered(True)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/tmp/wifi_in.pcap', True)
        self.blocks_file_sink_0.set_unbuffered(True)
        self.Wifi_tx_PHY_0 = Wifi_tx_PHY(
            encoding=ieee802_11.BPSK_1_2,
        )
        self.Wifi_rx_PHY_0 = Wifi_rx_PHY(
            bandwidth=10e6,
        ...
        # Connections
        ##################################################
        self.msg_connect((self.Wifi_rx_PHY_0, 'carrier'), (self.blocks_pdu_to_tagged_stream_0_0, 'pdus'))
        self.msg_connect((self.Wifi_rx_PHY_0, 'mac_out'), (self.foo_wireshark_connector_0, 'in'))
        self.msg_connect((self.Wifi_rx_PHY_0, 'mac_out'), (self.ieee802_11_parse_mac_0, 'in'))
        self.msg_connect((self.Wifi_rx_PHY_0, 'mac_out'), (self.ieee802_11_rx_mac_0, 'phy in'))
        self.msg_connect((self.blocks_message_strobe_0, 'strobe'), (self.ieee802_11_tx_mac_0, 'app in'))
        self.msg_connect((self.ieee802_11_message_handler_0, 'message out'), (self.blocks_message_debug_0, 'print'))
        self.msg_connect((self.ieee802_11_message_handler_0, 'SNR out'), (self.ieee802_11_threshold_generator_0, 'SNR in'))
        self.msg_connect((self.ieee802_11_parse_mac_0, 'fer'), (self.ieee802_11_threshold_generator_0, 'FER in'))
        self.msg_connect((self.ieee802_11_rx_mac_0, 'app out'), (self.ieee802_11_message_handler_0, 'app in'))
        self.msg_connect((self.ieee802_11_threshold_generator_0, 'threshold out'), (self.Wifi_rx_PHY_0, 'in_threshold'))
        self.msg_connect((self.ieee802_11_tx_mac_0, 'phy out'), (self.Wifi_tx_PHY_0, 'mac_in'))
        self.msg_connect((self.ieee802_11_tx_mac_0, 'phy out'), (self.foo_wireshark_connector_0_0, 'in'))
        self.connect((self.Wifi_rx_PHY_0, 0), (self.ieee802_11_threshold_generator_0, 0))
        self.connect((self.Wifi_tx_PHY_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.foo_packet_pad2_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.Wifi_rx_PHY_0, 0))
    ...
    def set_snr(self, snr):
        self.snr = snr
        self.blocks_multiply_const_vxx_0_0.set_k((self.snr, ))
    ...
    def set_rx_gain(self, rx_gain):
        ...
        self.ieee802_11_threshold_generator_0.set_Rxgain(self.rx_gain)
...
def main(top_block_cls=nodo_wifi, options=None):
