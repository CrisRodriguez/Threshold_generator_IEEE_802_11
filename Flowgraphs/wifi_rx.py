...
# Title: Wifi Rx
# Generated: Tue Jul 25 19:18:40 2017
##################################################
...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ieee802_11_sync_short_0 = ieee802_11.sync_short(2, False, False)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/tmp/wifi2.pcap', True)
